...
GameData["critical_bag"]["actions"]["action_01"]["slot_item"] = [[slot_item\axis_sdkfz_251_halftrack_mg42_rear.lua]]
GameData["critical_bag"]["actions"]["action_02"] = Reference([[action\critical_action\remove_crew_action.lua]])
GameData["critical_bag"]["actions"]["action_02"]["crew_name"] = [[Gunner_Rear]]
GameData["critical_bag"]["actions"]["action_02"]["kill"] = true 
GameData["critical_bag"]["kicker_message"]["message"] = "$164800"
...
GameData["critical_bag"]["requirements"]["required_1"]["slot_item"] = [[slot_item\axis_sdkfz_251_halftrack_mg42_rear.lua]]
