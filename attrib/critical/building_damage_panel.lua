...
GameData["critical_bag"]["actions"]["action_01"]["damage_type"] = [[damage_panel]]
GameData["critical_bag"]["actions"]["action_01"]["radius"] = 1
GameData["critical_bag"]["actions"]["action_01"]["random_radius_offset"] = 0.5
GameData["critical_bag"]["actions"]["action_01"]["start_radius"] = 1
GameData["critical_bag"]["actions"]["action_01"]["use_weapon_radius"] = false
GameData["critical_bag"]["description"] = [[Damage Panel]]
