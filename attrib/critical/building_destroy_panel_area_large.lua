...
GameData["critical_bag"]["actions"]["action_01"]["damage_style"] = [[sphere_burst\satchel.lua]]
...
GameData["critical_bag"]["actions"]["action_01"]["start_radius"] = 0.5
GameData["critical_bag"]["actions"]["action_01"]["use_weapon_radius"] = false
GameData["critical_bag"]["description"] = [[Destroy Panel Area (Large)]]
