...
GameData["critical_bag"]["actions"]["action_01"]["slot_item"] = [[slot_item\axis_stug_iv_top_mg42.lua]]
...
GameData["critical_bag"]["requirements"]["required_1"]["slot_item"] = [[slot_item\axis_stug_iv_top_mg42.lua]]
