...
GameData["critical_bag"]["actions"]["action_01"]["radius"] = 5.5
GameData["critical_bag"]["actions"]["action_01"]["random_radius_offset"] = 0.5
GameData["critical_bag"]["actions"]["action_01"]["start_radius"] = 4
...
GameData["critical_bag"]["actions"]["action_02"]["damage_type"] = [[damage_accessory_area]]
GameData["critical_bag"]["actions"]["action_02"]["radius"] = 10
GameData["critical_bag"]["description"] = [[Destroy Panel Area Goliath]]
