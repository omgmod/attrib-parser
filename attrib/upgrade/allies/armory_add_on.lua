...
GameData["upgrade_bag"]["time_cost"]["cost"]["manpower"] = 180
GameData["upgrade_bag"]["time_cost"]["cost"]["munition"] = 140
...
GameData["upgrade_bag"]["ui_info"]["icon_name"] = [[buildings\icon_building_allied_barracks_armoury]]
