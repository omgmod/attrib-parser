...
GameData["upgrade_bag"]["actions"]["action_03"]["slot_item"] = [[slot_item\allies_thompson_smg.lua]]
GameData["upgrade_bag"]["actions"]["action_04"] = Reference([[action\upgrade_action\slot_item_add.lua]])
GameData["upgrade_bag"]["actions"]["action_04"]["slot_item"] = [[slot_item\allies_thompson_smg.lua]]
