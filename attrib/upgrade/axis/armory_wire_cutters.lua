...
GameData["upgrade_bag"]["speech_code_3"]["code_1"] = [[cuw]]
...
GameData["upgrade_bag"]["ui_info"]["hotkey_name"] = [[armory_wire_cutters]]
GameData["upgrade_bag"]["ui_info"]["icon_name"] = [[upgrades\icon_upgrade_allied_wirecutters]]
