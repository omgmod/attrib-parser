...
GameData["upgrade_bag"]["requirements"]["required_1"]["upgrade_name"] = [[upgrade\axis\axis_resource_upgrade_advanced.lua]]
...
GameData["upgrade_bag"]["ui_info"]["icon_name"] = [[research\icon_research_allied_rank_4]]
