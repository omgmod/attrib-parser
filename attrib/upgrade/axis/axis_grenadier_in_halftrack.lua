...
GameData["upgrade_bag"]["actions"]["action_01"] = Reference([[action\upgrade_action\garrison_squad_action.lua]])
GameData["upgrade_bag"]["actions"]["action_01"]["squad_blueprint"] = [[sbps\races\axis\soldiers\grenadier_squad.lua]]
