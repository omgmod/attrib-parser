...
GameData["upgrade_bag"]["actions"]["action_02"]["modifiers"]["modifier_02"] = Reference([[modifiers\received_damage_modifier.lua]])
GameData["upgrade_bag"]["actions"]["action_02"]["modifiers"]["modifier_02"]["value"] = 0.5
...
GameData["upgrade_bag"]["ui_info"]["icon_name"] = [[upgrades\icon_upgrade_axis_knights_cross_inf]]
