...
GameData["upgrade_bag"]["actions"]["action_01"]["slot_item"] = [[slot_item\axis_mg42_hmg_item.lua]]
...
GameData["upgrade_bag"]["ui_info"]["hotkey_name"] = [[upgrades\icon_upgrade_axis_mg42]]
