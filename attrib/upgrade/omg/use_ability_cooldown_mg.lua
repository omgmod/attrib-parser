...
GameData["upgrade_bag"]["actions"]["action_01"]["delay"] = 100
...
GameData["upgrade_bag"]["actions"]["action_01"]["delayed_actions"]["action_04"]["upgrade"] = [[upgrade\omg\use_ability_cooldown_mg.rgd]]
