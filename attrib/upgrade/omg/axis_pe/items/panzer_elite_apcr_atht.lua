...
GameData["upgrade_bag"]["actions"]["action_02"]["weapon"]["origin"]["x"] = -0.1200000048
GameData["upgrade_bag"]["actions"]["action_02"]["weapon"]["origin"]["y"] = 2.25
GameData["upgrade_bag"]["actions"]["action_02"]["weapon"]["weapon"] = [[weapon\axis_pe\ballistic_weapon\anti_tank_gun\apcr_37mm_pak_35_halftrack.lua]]
GameData["upgrade_bag"]["actions"]["action_03"] = Reference([[action\upgrade_action\change_weapon.lua]])
GameData["upgrade_bag"]["actions"]["action_03"]["weapon"] = [[weapon\axis_pe\ballistic_weapon\anti_tank_gun\apcr_37mm_pak_35_halftrack.lua]]
