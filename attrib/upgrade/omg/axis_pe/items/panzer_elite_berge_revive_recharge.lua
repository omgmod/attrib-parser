...
GameData["upgrade_bag"]["actions"]["action_02"]["delay"] = 30
GameData["upgrade_bag"]["actions"]["action_02"]["delayed_actions"]["action_01"] = Reference([[action\upgrade_action\slot_item_add.lua]])
GameData["upgrade_bag"]["actions"]["action_02"]["delayed_actions"]["action_01"]["slot_item"] = [[slot_item\panzer_elite_berge_revive.rgd]]
GameData["upgrade_bag"]["actions"]["action_02"]["delayed_actions"]["action_03"] = Reference([[action\upgrade_action\upgrade_remove.lua]])
GameData["upgrade_bag"]["actions"]["action_02"]["delayed_actions"]["action_03"]["upgrade"] = [[upgrade\omg\axis_pe\items\panzer_elite_berge_revive_recharge.lua]]
