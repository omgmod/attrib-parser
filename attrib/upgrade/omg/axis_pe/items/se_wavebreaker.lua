...
GameData["upgrade_bag"]["actions"]["action_01"] = Reference([[action\upgrade_action\replace_ability_action]])
GameData["upgrade_bag"]["actions"]["action_01"]["ability_to_add"] = [[abilities\omg\doctrine\t3_wavebreaker_aura.rgd]]
