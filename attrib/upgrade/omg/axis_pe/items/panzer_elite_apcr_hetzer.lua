...
GameData["upgrade_bag"]["actions"]["action_02"]["weapon"]["origin"]["x"] = 1
GameData["upgrade_bag"]["actions"]["action_02"]["weapon"]["origin"]["y"] = 2
GameData["upgrade_bag"]["actions"]["action_02"]["weapon"]["weapon"] = [[weapon\axis_pe\ballistic_weapon\tank_gun\apcr_pak39_hetzer_gun.lua]]
GameData["upgrade_bag"]["actions"]["action_03"] = Reference([[action\upgrade_action\change_weapon.lua]])
GameData["upgrade_bag"]["actions"]["action_03"]["weapon"] = [[weapon\axis_pe\ballistic_weapon\tank_gun\apcr_pak39_hetzer_gun.lua]]
