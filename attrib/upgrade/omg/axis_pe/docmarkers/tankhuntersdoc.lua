...
GameData["upgrade_bag"]["actions"]["action_02"]["apply_to_entities_in_squad"] = true 
GameData["upgrade_bag"]["actions"]["action_02"]["upgrade"] = [[upgrade\omg\omg_water_buff.rgd]]
