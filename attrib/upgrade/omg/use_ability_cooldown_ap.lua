...
GameData["upgrade_bag"]["actions"]["action_01"]["delay"] = 230
GameData["upgrade_bag"]["actions"]["action_01"]["delayed_actions"] = Reference([[tables\upgrade_action_table.lua]])
GameData["upgrade_bag"]["actions"]["action_01"]["delayed_actions"]["action_04"] = Reference([[action\upgrade_action\upgrade_remove.lua]])
GameData["upgrade_bag"]["actions"]["action_01"]["delayed_actions"]["action_04"]["apply_to_entities_in_squad"] = true 
GameData["upgrade_bag"]["actions"]["action_01"]["delayed_actions"]["action_04"]["upgrade"] = [[upgrade\omg\use_ability_cooldown_AP.rgd]]
GameData["upgrade_bag"]["actions"]["action_01"]["progress_bar"] = true 
