...
GameData["upgrade_bag"]["actions"]["action_01"]["ability_to_remove"] = [[abilities\omg\vet\Allied_Engineer_Vet3_Constructing_Modifier.rgd]]
GameData["upgrade_bag"]["actions"]["action_02"] = Reference([[action\upgrade_action\replace_ability_action.lua]])
GameData["upgrade_bag"]["actions"]["action_02"]["ability_to_remove"] = [[abilities\omg\vet\Allied_Engineer_Vet1_Constructing_Modifier.rgd]]
