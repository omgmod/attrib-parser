...
GameData["upgrade_bag"]["actions"]["action_01"]["modifiers"]["modifier_01"]["value"] = 1.25
...
GameData["upgrade_bag"]["actions"]["action_02"]["slot_item"] = [[slot_item\saboteur_greesegun.rgd]]
