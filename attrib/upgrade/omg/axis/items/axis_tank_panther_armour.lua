...
GameData["upgrade_bag"]["actions"]["action_02"]["new_type"] = [[type_target_weapon\tp_armour_axis_panther_skirts.lua]]
GameData["upgrade_bag"]["actions"]["action_02"]["original_type"] = [[type_target_weapon\tp_armour_axis_panther.lua]]
GameData["upgrade_bag"]["actions"]["action_03"] = Reference([[action\upgrade_action\slot_item_add.lua]])
GameData["upgrade_bag"]["actions"]["action_03"]["new_type"] = [[type_target_weapon\tp_armour_axis_panther_skirts.lua]]
