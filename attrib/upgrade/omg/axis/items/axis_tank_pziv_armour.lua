...
GameData["upgrade_bag"]["actions"]["action_02"]["new_type"] = [[type_target_weapon\tp_armour_axis_panzeriv_skirts.lua]]
GameData["upgrade_bag"]["actions"]["action_02"]["original_type"] = [[type_target_weapon\tp_armour_axis_panzeriv.lua]]
