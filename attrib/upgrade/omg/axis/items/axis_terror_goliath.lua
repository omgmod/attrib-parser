...
GameData["upgrade_bag"]["actions"]["action_01"]["upgrade"] = [[upgrade\omg\axis\items\axis_goliath.lua]]
GameData["upgrade_bag"]["actions"]["action_02"] = Reference([[action\upgrade_action\slot_item_add.lua]])
GameData["upgrade_bag"]["actions"]["action_02"]["slot_item"] = [[slot_item\axis_terror_goliath.rgd]]
