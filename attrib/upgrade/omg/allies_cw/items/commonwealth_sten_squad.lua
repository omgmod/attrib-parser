...
GameData["upgrade_bag"]["actions"]["action_01"]["weapon"]["weapon"] = [[weapon\allies_cw\small_arms\machine_gun\sub_machine_gun\cw_sten_smg_silencer.lua]]
GameData["upgrade_bag"]["actions"]["action_02"] = Reference([[action\upgrade_action\change_weapon.lua]])
GameData["upgrade_bag"]["actions"]["action_02"]["weapon"] = [[weapon\allies_cw\small_arms\machine_gun\sub_machine_gun\cw_sten_smg_silencer.lua]]
GameData["upgrade_bag"]["actions"]["action_03"] = Reference([[tables\action_table.lua]])
GameData["upgrade_bag"]["actions"]["action_03"]["upgrade_actions"]["action_01"] = Reference([[action\upgrade_action\slot_item_add.lua]])
GameData["upgrade_bag"]["actions"]["action_03"]["upgrade_actions"]["action_01"]["slot_item"] = [[slot_item\cw_sten_smg]]
