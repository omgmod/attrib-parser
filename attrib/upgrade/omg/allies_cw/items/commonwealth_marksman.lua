...
GameData["upgrade_bag"]["actions"]["action_01"]["modifiers"]["modifier_04"] = Reference([[modifiers\sight_radius_modifier.lua]])
GameData["upgrade_bag"]["actions"]["action_01"]["modifiers"]["modifier_04"]["usage_type"] = [[addition]]
GameData["upgrade_bag"]["actions"]["action_01"]["modifiers"]["modifier_04"]["value"] = 0
