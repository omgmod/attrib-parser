...
GameData["upgrade_bag"]["actions"]["action_02"] = Reference([[action\ability_action\upgrade_add.lua]])
GameData["upgrade_bag"]["actions"]["action_02"]["apply_to_entities_in_squad"] = true 
GameData["upgrade_bag"]["actions"]["action_02"]["upgrade"] = [[upgrade\omg\allies_cw\items\commonwealth_atap.lua]]
