...
GameData["upgrade_bag"]["actions"]["action_01"]["subactions"]["action_02"]["delayed_actions"]["action_01"]["ability_to_add"] = [[abilities\cmw_at_apc_shell_two.rgd]]
GameData["upgrade_bag"]["actions"]["action_01"]["subactions"]["action_02"]["delayed_actions"]["action_01"]["ability_to_remove"] = [[abilities\cmw_at_apc_shell_one.rgd]]
...
GameData["upgrade_bag"]["actions"]["action_01"]["subactions"]["action_02"]["delayed_actions"]["action_04"]["upgrade"] = [[upgrade\omg\allies_cw\items\commonwealth_apat_use1.rgd]]
