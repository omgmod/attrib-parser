...
GameData["upgrade_bag"]["actions"]["action_01"]["slot_item"] = [[slot_item\commonwealth_mines.rgd]]
GameData["upgrade_bag"]["actions"]["action_02"] = Reference([[action\upgrade_action\slot_item_add.lua]])
GameData["upgrade_bag"]["actions"]["action_02"]["slot_item"] = [[slot_item\commonwealth_mines.rgd]]
