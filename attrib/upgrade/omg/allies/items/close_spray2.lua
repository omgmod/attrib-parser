...
GameData["upgrade_bag"]["actions"]["action_01"]["weapon"]["weapon"] = [[weapon\allies\small_arms\machine_gun\sub_machine_gun\ m3_smg_doctrin.rgd]]
GameData["upgrade_bag"]["actions"]["action_02"] = Reference([[action\upgrade_action\change_weapon.lua]])
GameData["upgrade_bag"]["actions"]["action_02"]["weapon"] = [[weapon\allies\small_arms\machine_gun\sub_machine_gun\ m3_smg_doctrin.rgd]]
GameData["upgrade_bag"]["actions"]["action_05"] = Reference([[action\upgrade_action\slot_item_add.lua]])
GameData["upgrade_bag"]["actions"]["action_05"]["slot_item"] = [[slot_item\ allies_greesegun.rgd]]
