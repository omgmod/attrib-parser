...
GameData["upgrade_bag"]["actions"]["action_01"]["do_action_state_name"] = [[visible]]
GameData["upgrade_bag"]["actions"]["action_01"]["state_machine_name"] = [[sdkfz_223]]
GameData["upgrade_bag"]["actions"]["action_02"] = Reference([[action\upgrade_action\animator_set_state.lua]])
GameData["upgrade_bag"]["actions"]["action_02"]["do_action_state_name"] = [[invisible]]
GameData["upgrade_bag"]["actions"]["action_02"]["state_machine_name"] = [[sdkfz_222]]
GameData["upgrade_bag"]["actions"]["action_03"] = Reference([[action\upgrade_action\animator_set_state.lua]])
GameData["upgrade_bag"]["actions"]["action_03"]["do_action_state_name"] = [[invisible]]
GameData["upgrade_bag"]["actions"]["action_03"]["state_machine_name"] = [[sdkfz_221]]
