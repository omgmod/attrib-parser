...
GameData["upgrade_bag"]["actions"]["action_01"]["action_table"]["upgrade_actions"]["action_01"]["ability_to_add"] = [[abilities\ally_throw_sticky_bombs.lua]]
GameData["upgrade_bag"]["actions"]["action_01"]["apply_to_future_units"] = true 
GameData["upgrade_bag"]["actions"]["action_01"]["entity_type"] = [[ebps\races\allies\soldiers\airborne_infantry.lua]]
