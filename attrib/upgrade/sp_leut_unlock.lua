...
GameData["upgrade_bag"]["actions"]["action_01"] = Reference([[action\upgrade_action\set_crush_obb.lua]])
GameData["upgrade_bag"]["actions"]["action_01"]["offset_scale_x"] = 10
GameData["upgrade_bag"]["actions"]["action_01"]["offset_scale_y"] = 10
GameData["upgrade_bag"]["actions"]["action_01"]["offset_scale_z"] = 10
