...
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_02"]["upgrade"] = [[upgrade\omg\allies\items\allies_apat_use1.rgd]]
...
GameData["ability_bag"]["requirements"]["required_2"]["upgrade_name"] = [[upgrade\omg\allies\items\allies_apat_use1.rgd]]
