...
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_01"]["hardpoint"] = 1
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_01"]["interval"] = 5
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_01"]["num_shots"] = 1
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_02"] = Reference([[action\ability_action\animator_set_action.lua]])
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_02"]["action_name"] = [[UI\overwatch_artillery_indicator]]
...
GameData["ability_bag"]["toggled_recharge_time_on"] = 20
