...
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_01"] = Reference([[action\ability_action\delay]])
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_01"]["delay"] = 3
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_01"]["delayed_actions"]["action_01"] = Reference([[action\critical_action\timed_action.lua]])
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_01"]["delayed_actions"]["action_01"]["duration"] = 2.5
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_01"]["delayed_actions"]["action_01"]["fire_and_forget"] = true 
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_01"]["delayed_actions"]["action_01"]["subactions"]["ability_actions"]["action_02"] = Reference([[action\ability_action\apply_modifiers_action.lua]])
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_01"]["delayed_actions"]["action_01"]["subactions"]["ability_actions"]["action_02"]["modifiers"]["modifier_01"] = Reference([[modifiers\enable_weapon_modifier.lua]])
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_01"]["delayed_actions"]["action_01"]["subactions"]["ability_actions"]["action_02"]["modifiers"]["modifier_01"]["target_type_name"] = [[hardpoint_01]]
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_01"]["delayed_actions"]["action_01"]["subactions"]["ability_actions"]["action_02"]["modifiers"]["modifier_01"]["value"] = -1
...
GameData["ability_bag"]["requirements"]["required_3"]["upgrade_name"] = [[upgrade\omg\axis_pe\docmarkers\scorched\tr1\b1\t2.rgd]]
