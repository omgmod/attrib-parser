...
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_02"]["delay"] = 3.700000048
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_02"]["delayed_actions"]["action_02"] = Reference([[action\ability_action\use_accessory_weapon.lua]])
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_02"]["delayed_actions"]["action_02"]["accessory_weapon_item"] = [[slot_item\panzer_elite_incendiary_grenade_scorched.rgd]]
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_02"]["delayed_actions"]["action_02"]["no_decrement"] = true 
