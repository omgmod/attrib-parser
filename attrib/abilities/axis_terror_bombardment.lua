...
GameData["ability_bag"]["cost"]["munition"] = 160
...
GameData["ability_bag"]["requirements"]["required_2"]["requirement_table_1"]["required_1"]["upgrade_name"] = [[upgrade\axis_propaganda_11.lua]]
