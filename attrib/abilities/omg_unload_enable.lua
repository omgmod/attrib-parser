...
GameData["ability_bag"]["action_list"]["start_self_actions"]["action_01"]["duration"] = -1
GameData["ability_bag"]["action_list"]["start_self_actions"]["action_01"]["modifiers"]["modifier_01"] = Reference([[modifiers\hold_unload_enable.lua]])
