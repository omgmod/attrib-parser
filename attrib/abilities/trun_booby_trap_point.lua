...
GameData["ability_bag"]["requirements"]["required_1"]["upgrade_name"] = [[upgrade\trun_booby_trap_points.lua]]
...
GameData["ability_bag"]["ui_info"]["hotkey_name"] = [[axis_boobytrap_strategicpoint_trun]]
