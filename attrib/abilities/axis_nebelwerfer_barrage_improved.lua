...
GameData["ability_bag"]["requirements"]["required_1"]["race"] = [[racebps\axis_infantry_company.lua]]
...
GameData["ability_bag"]["requirements"]["required_2"]["upgrade_name"] = [[upgrade\sp_m08_improved_nebelwerfer.lua]]
