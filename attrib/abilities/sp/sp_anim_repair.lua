...
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_01"]["do_action_state_name"] = [[Inactive]]
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_01"]["state_machine_name"] = [[Blowtorch_State]]
