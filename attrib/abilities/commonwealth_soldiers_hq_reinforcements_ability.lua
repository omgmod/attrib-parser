...
GameData["ability_bag"]["action_list"]["end_target_actions"]["action_01"] = Reference([[action\ability_action\reinforcements_action.lua]])
GameData["ability_bag"]["action_list"]["end_target_actions"]["action_01"]["points_total"] = 1000
GameData["ability_bag"]["action_list"]["end_target_actions"]["action_01"]["spawn_random_squads"] = false
GameData["ability_bag"]["action_list"]["end_target_actions"]["action_01"]["squad_table"]["squad_01"] = [[sbps\races\allies_commonwealth\vehicles\soldiers_hq_squad.lua]]
...
GameData["ability_bag"]["cost"]["fuel"] = 30
GameData["ability_bag"]["cost"]["manpower"] = 185
...
GameData["ability_bag"]["requirements"]["required_1"]["upgrade_name"] = [[upgrade\allies_cw\commonwealth_building_lieutenant_upgrade.lua]]
GameData["ability_bag"]["requirements"]["required_2"] = Reference([[requirements\required_entity_upgrade.lua]])
GameData["ability_bag"]["requirements"]["required_2"]["upgrade_name"] = [[upgrade\allies_cw\commonwealth_building_enable_spawning.lua]]
...
GameData["ability_bag"]["ui_info"]["help_text"] = "$128401"
GameData["ability_bag"]["ui_info"]["icon_name"] = [[buildings\building_cmnw_HQ_infantry]]
GameData["ability_bag"]["ui_info"]["screen_name"] = "$128400"
