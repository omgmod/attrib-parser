...
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_01"]["accessory_weapon_item"] = [[slot_item\la_fiere_canister_ammunition.lua]]
...
GameData["ability_bag"]["ui_info"]["help_text"] = "$148850"
