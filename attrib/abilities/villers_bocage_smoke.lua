...
GameData["ability_bag"]["action_list"]["start_self_actions"]["action_01"]["duration"] = 28
...
GameData["ability_bag"]["requirements"]["required_1"]["upgrade_name"] = [[upgrade\villers_bocage_unlock_firefly_smoke.lua]]
