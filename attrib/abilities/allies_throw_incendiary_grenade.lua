...
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_01"]["accessory_weapon_item"] = [[slot_item\allies_fallschirmjager_incendiary.lua]]
