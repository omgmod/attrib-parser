...
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_04"]["upgrade"] = [[upgrade\omg\allies_cw\items\commonwealth_apat_use2.rgd]]
...
GameData["ability_bag"]["requirements"]["required_2"]["upgrade_name"] = [[upgrade\omg\allies_cw\items\commonwealth_apat_use2.rgd]]
