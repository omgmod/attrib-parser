...
GameData["ability_bag"]["requirements"]["required_1"]["requirement_table_1"]["required_1"]["upgrade_name"] = [[upgrade\allied_airborne_11.lua]]
...
GameData["ability_bag"]["speech_code_3"]["code_1"] = [[ast]]
