...
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_03"]["delay"] = 4.5
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_03"]["delay_min"] = 3.5
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_03"]["delayed_actions"]["action_01"] = Reference([[action\ability_action\use_accessory_weapon.lua]])
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_03"]["delayed_actions"]["action_01"]["accessory_weapon_item"] = [[slot_item\axis_fire_panzerfaust.lua]]
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_03"]["delayed_actions"]["action_01"]["no_decrement"] = true 
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_03"]["delayed_actions"]["action_02"] = Reference([[action\ability_action\delay.lua]])
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_03"]["delayed_actions"]["action_02"]["delay"] = 0.75
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_03"]["delayed_actions"]["action_02"]["delay_min"] = 0.25
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_03"]["delayed_actions"]["action_02"]["delayed_actions"]["action_02"] = Reference([[action\upgrade_action\slot_item_add.lua]])
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_03"]["delayed_actions"]["action_02"]["delayed_actions"]["action_02"]["fire_and_forget"] = true 
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_03"]["delayed_actions"]["action_02"]["delayed_actions"]["action_02"]["random"] = false
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_03"]["delayed_actions"]["action_02"]["delayed_actions"]["action_02"]["slot_item"] = [[slot_item\axis_pfaust.rgd]]
...
GameData["ability_bag"]["requirements"]["required_1"]["upgrade_name"] = [[upgrade\omg\axis_pe\docmarkers\luftwaffe\tr1\b2\t2.rgd]]
