...
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_01"]["upgrade"] = [[upgrade\omg\allies\items\t2_smoke_run.rgd]]
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_01"] = Reference([[action\ability_action\air_strike_action.lua]])
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_01"]["aircraft_name"] = [[ebps\races\allies\vehicles\p47_thunderbolt_smoke.lua]]
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_01"]["source_offset_x"] = 2
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_01"]["source_offset_y"] = 2
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_01"]["source_offset_z"] = 2
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_01"]["time_range_between_planes_maximum"] = 4.5
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_01"]["time_range_between_planes_minimum"] = 2.5
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_02"] = Reference([[action\ability_action\trigger_dca_action.lua]])
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_02"]["dca_action_name"] = [[UI\Grandslam_Signal_Smoke]]
...
GameData["ability_bag"]["requirements"]["required_1"]["upgrade_name"] = [[upgrade\omg\allies\items\t2_smoke_run.rgd]]
