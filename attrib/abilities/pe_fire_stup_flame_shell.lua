...
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_01"]["accessory_weapon_item"] = [[slot_item\StuP_fire_flame_petard.lua]]
...
GameData["ability_bag"]["shared_timer"] = [[StuP]]
