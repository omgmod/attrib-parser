...
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_01"]["aircraft_name"] = [[ebps\races\axis\vehicles\ju87_stuka.rgd]]
...
GameData["ability_bag"]["ui_info"]["icon_name"] = [[abilities\ability_axis_stuka]]
