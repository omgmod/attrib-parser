...
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_02"]["delayed_actions"]["action_02"]["accessory_weapon_item"] = [[slot_item\panzer_elite_incendiary_grenade.lua]]
