...
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_01"]["modifiers"]["modifier_03"]["value"] = 1.5
...
GameData["ability_bag"]["action_list"]["end_self_actions"]["action_01"]["modifiers"]["modifier_04"]["value"] = 1.5
...
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_06"]["delayed_actions"]["action_01"] = Reference([[action\ability_action\suppression.lua]])
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_06"]["delayed_actions"]["action_02"] = Reference([[action\ability_action\delay.lua]])
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_06"]["delayed_actions"]["action_02"]["delayed_actions"]["action_01"] = Reference([[action\ability_action\suppression.lua]])
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_06"]["delayed_actions"]["action_02"]["delayed_actions"]["action_02"] = Reference([[action\ability_action\delay.lua]])
GameData["ability_bag"]["action_list"]["start_target_actions"]["action_06"]["delayed_actions"]["action_02"]["delayed_actions"]["action_02"]["delayed_actions"]["action_01"] = Reference([[action\ability_action\suppression.lua]])
