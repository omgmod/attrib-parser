...
GameData["slot_item_bag"]["ui_info"]["icon_name"] = [[upgrades\icon_upgrade_allied_satchel]]
...
GameData["slot_item_bag"]["weapon"]["weapon"] = [[weapon\allies\ballistic_weapon\grenade\villers_bocage_satchel_charge_throw.lua]]
