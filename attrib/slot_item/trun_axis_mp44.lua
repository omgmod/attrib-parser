...
GameData["slot_item_bag"]["ui_info"]["hotkey_name"] = [[axis_mp44]]
...
GameData["slot_item_bag"]["weapon"]["weapon"] = [[weapon\axis\small_arms\machine_gun\sub_machine_gun\trun_mp44_assault_rifle.lua]]
