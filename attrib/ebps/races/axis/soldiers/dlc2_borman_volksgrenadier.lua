...
GameData["engineer_ext"]["construction_menus"]["construction_menu_01"]["construction_type"] = [[tp_construction_axis_infantry_basic]]
...
GameData["entity_blueprint_ext"]["animator"] = [[Races\Axis\Soldiers\Borman]]
