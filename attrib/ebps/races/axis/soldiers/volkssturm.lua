...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\axis\small_arms\single_fire\rifle\kar_98k_rifle_vg_geriatric.lua]]
...
GameData["cover_ext"]["tp_heavy"]["safety_value"] = 0.6999999881
