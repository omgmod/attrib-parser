...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\plane_weapons\stuka_bomb_luft.rgd]]
...
GameData["flight_ext"]["height_target"] = 35
