...
GameData["ability_ext"]["abilities"]["ability_04"] = [[abilities\omg\vet\CMW_Cpt_Vet3_Victor.rgd]]
GameData["ability_ext"]["abilities"]["ability_05"] = [[abilities\captain_force_multiplier_vet2.lua]]
