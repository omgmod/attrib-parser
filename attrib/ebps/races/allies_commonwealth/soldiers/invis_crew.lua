...
GameData["action_apply_ext"]["actions"]["ability_actions"]["action_01"] = Reference([[action\upgrade_action\upgrade_add.lua]])
GameData["action_apply_ext"]["actions"]["ability_actions"]["action_01"]["apply_to_entities_in_squad"] = true 
GameData["action_apply_ext"]["actions"]["ability_actions"]["action_01"]["upgrade"] = [[upgrade\omg\emplacement_crew_death.lua]]
