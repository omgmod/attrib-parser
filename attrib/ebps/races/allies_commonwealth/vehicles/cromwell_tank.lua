...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\allies_cw\ballistic_weapon\tank_gun\cw_oqf_75mm_cromwell_gun.lua]]
...
GameData["cost_ext"]["time_cost"]["cost"]["fuel"] = 70
