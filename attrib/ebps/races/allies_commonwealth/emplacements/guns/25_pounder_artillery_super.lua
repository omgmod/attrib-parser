...
GameData["ability_ext"]["abilities"]["ability_11"] = [[abilities\omg\emplacements\move\retreat_fast_25pdr_super.lua]]
GameData["ability_ext"]["abilities"]["ability_12"] = [[abilities\omg\emplacements\move\retreat_full_25pdr_super.lua]]
GameData["ability_ext"]["abilities"]["ability_13"] = [[abilities\omg\emplacements\move\pack_25pdr_super.lua]]
...
GameData["action_apply_ext"]["actions"]["upgrade_actions"]["action_01"] = Reference([[action\upgrade_action\upgrade_add.lua]])
GameData["action_apply_ext"]["actions"]["upgrade_actions"]["action_01"]["upgrade"] = [[upgrade\omg\allies_cw\items\commonwealth_supercharge_shells.lua]]
GameData["action_apply_ext"]["actions"]["upgrade_actions"]["action_02"] = Reference([[action\upgrade_action\upgrade_add.lua]])
GameData["action_apply_ext"]["actions"]["upgrade_actions"]["action_02"]["upgrade"] = [[upgrade\omg\allies_cw\items\commonwealth_overwatch.lua]]
GameData["action_apply_ext"]["actions"]["upgrade_actions"]["action_03"] = Reference([[action\upgrade_action\upgrade_add.lua]])
GameData["action_apply_ext"]["actions"]["upgrade_actions"]["action_03"]["upgrade"] = [[upgrade\omg\allies_cw\items\commonwealth_creeping_barrage.lua]]
GameData["action_apply_ext"]["actions"]["upgrade_actions"]["action_04"] = Reference([[action\upgrade_action\upgrade_add.lua]])
GameData["action_apply_ext"]["actions"]["upgrade_actions"]["action_04"]["upgrade"] = [[upgrade\omg\allies_cw\items\commonwealth_counter_battery.lua]]
...
GameData["construction_ext"]["construction_menus"]["construction_menu_entry_01"]["construction_type"] = [[omg_tp_construction_25pdr_super_cmw]]
...
GameData["modifier_apply_ext"]["modifiers"]["modifier_01"] = Reference([[modifiers\ability_max_range_modifier.lua]])
GameData["modifier_apply_ext"]["modifiers"]["modifier_01"]["target_type_name"] = [[abilities\overwatch_barrage_25_pounder.lua]]
GameData["modifier_apply_ext"]["modifiers"]["modifier_01"]["usage_type"] = [[multiplication]]
GameData["modifier_apply_ext"]["modifiers"]["modifier_01"]["value"] = 1.5
...
GameData["team_weapon_ext"]["on_abandon_action"]["ability_actions"]["action_01"]["upgrade"] = [[upgrade\omg\emplacements\move_25pdr_super.lua]]
...
GameData["upgrade_apply_ext"]["upgrade_table"]["upgrade_01"] = [[upgrade\omg\emplacements\build_25pdr_super.lua]]
