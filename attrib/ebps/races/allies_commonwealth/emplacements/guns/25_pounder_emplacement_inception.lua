...
GameData["construction_ext"]["on_construction_actions"]["upgrade_actions"]["action_02"]["squad_blueprint"] = [[sbps\races\allies_commonwealth\vehicles\artillery_nest_squad.lua]]
