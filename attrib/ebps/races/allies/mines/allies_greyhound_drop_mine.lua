...
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["weapon"] = [[weapon\allies\ballistic_weapon\grenade\mine_improved.lua]]
...
GameData["type_ext"]["unit_type_list"]["unit_type00"] = [[military]]
