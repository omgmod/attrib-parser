...
GameData["action_apply_ext"]["actions"]["upgrade_actions"]["action_01"]["do_action_state_name"] = [[Off]]
GameData["action_apply_ext"]["actions"]["upgrade_actions"]["action_01"]["state_machine_name"] = [[Headlights]]
GameData["action_apply_ext"]["actions"]["upgrade_actions"]["action_02"] = Reference([[action\upgrade_action\animator_set_state.lua]])
GameData["action_apply_ext"]["actions"]["upgrade_actions"]["action_02"]["do_action_state_name"] = [[NotRunning]]
GameData["action_apply_ext"]["actions"]["upgrade_actions"]["action_02"]["state_machine_name"] = [[_EngineState]]
