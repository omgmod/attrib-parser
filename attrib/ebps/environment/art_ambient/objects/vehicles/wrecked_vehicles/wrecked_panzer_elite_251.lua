...
GameData["health_ext"]["rebuilt_entity"] = [[ebps\races\axis_panzer_elite\vehicles\251_munitions_halftrack_rebuilt.lua]]
GameData["health_ext"]["rebuilt_squad"] = [[sbps\races\axis_panzer_elite\vehicles\251_heavy_halftrack_squad.lua]]
