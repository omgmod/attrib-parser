...
GameData["health_ext"]["rebuilt_entity"] = [[ebps\races\axis\vehicles\tiger_ace_rebuilt.lua]]
GameData["health_ext"]["rebuilt_squad"] = [[sbps\races\axis\vehicles\tiger_ace_squad.lua]]
