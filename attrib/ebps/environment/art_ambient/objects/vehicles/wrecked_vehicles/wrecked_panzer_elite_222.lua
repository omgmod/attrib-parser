...
GameData["health_ext"]["rebuilt_entity"] = [[ebps\races\axis_panzer_elite\vehicles\222_light_armoured_car_rebuilt.lua]]
GameData["health_ext"]["rebuilt_squad"] = [[sbps\races\axis_panzer_elite\vehicles\222_armored_car_squad.lua]]
