...
GameData["health_ext"]["rebuilt_entity"] = [[ebps\races\axis\vehicles\ostwind_flak_panzer_rebuilt.lua]]
GameData["health_ext"]["rebuilt_squad"] = [[sbps\races\axis\vehicles\ostwind_flak_panzer_squad.lua]]
