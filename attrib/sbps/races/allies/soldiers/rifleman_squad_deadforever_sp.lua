...
GameData["squad_loadout_ext"]["unit_list"]["unit_01"]["type"]["type"] = [[ebps\races\allies\soldiers\infantry_rifleman_deadforever_sp.lua]]
...
GameData["squad_ui_ext"]["hotkey_name"] = [[allies_riflemen_deadforever_sp]]
