...
GameData["squad_upgrade_ext"]["upgrades"]["upgrade_01"] = [[upgrade\allies\items\allies_m2_flamethrower.lua]]
GameData["squad_upgrade_ext"]["upgrades"]["upgrade_02"] = [[upgrade\allies\items\allies_squad_item_minesweeper.lua]]
