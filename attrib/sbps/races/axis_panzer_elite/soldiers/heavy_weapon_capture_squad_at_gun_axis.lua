...
GameData["squad_action_apply_ext"]["actions"]["upgrade_actions"]["action_01"]["squad_type"] = [[sbps\races\axis_panzer_elite\soldiers\heavy_weapon_capture_squad_at_gun_axis.rgd]]
...
GameData["squad_ui_ext"]["screen_name"] = "$103950"
