...
GameData["squad_combat_stance_ext"]["ignore_building_stance"] = false
...
GameData["squad_loadout_ext"]["unit_list"]["unit_01"]["type"]["type"] = [[ebps\races\allies_commonwealth\emplacements\weapon_crew.lua]]
