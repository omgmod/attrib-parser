...
GameData["squad_ability_ext"]["abilities"]["ability_04"] = [[abilities\toggle_direct_fire.lua]]
...
GameData["squad_loadout_ext"]["unit_list"]["unit_01"]["type"]["type"] = [[ebps\races\allies_commonwealth\soldiers\sapper_anim_test.lua]]
