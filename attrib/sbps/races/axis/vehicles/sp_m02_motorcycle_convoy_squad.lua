...
GameData["squad_loadout_ext"]["unit_list"]["unit_01"]["type"]["type"] = [[ebps\races\axis\vehicles\sp_m02_motorcycle_convoy.lua]]
...
GameData["squad_ui_ext"]["hotkey_name"] = [[axis_motorcycle_convoy_squad]]
