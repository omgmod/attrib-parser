...
GameData["squad_ability_ext"]["abilities"]["ability_01"] = [[abilities\sp_defensive_smokecloud.lua]]
...
GameData["squad_loadout_ext"]["unit_list"]["unit_01"]["type"]["type"] = [[ebps\races\axis\vehicles\tiger_spg_ace.lua]]
