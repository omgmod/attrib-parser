...
GameData["squad_loadout_ext"]["unit_list"]["unit_01"]["type"]["type"] = [[ebps\races\axis\soldiers\volksgrenadier_deadforever_sp.lua]]
...
GameData["squad_ui_ext"]["hotkey_name"] = [[axis_volksgrenadier_squad_deadforever_sp]]
