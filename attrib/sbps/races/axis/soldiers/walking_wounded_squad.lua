...
GameData["squad_action_apply_ext"]["actions"]["upgrade_actions"]["action_01"] = Reference([[action\upgrade_action\alter_squad_ui_info_action.lua]])
GameData["squad_action_apply_ext"]["actions"]["upgrade_actions"]["action_01"]["ui_game_item_info"]["hotkey_name"] = [[axis_grenadier]]
GameData["squad_action_apply_ext"]["actions"]["upgrade_actions"]["action_01"]["ui_game_item_info"]["icon_name"] = [[units\unit_axis_grenadier]]
GameData["squad_action_apply_ext"]["actions"]["upgrade_actions"]["action_02"] = Reference([[action\upgrade_action\requirement_action]])
GameData["squad_action_apply_ext"]["actions"]["upgrade_actions"]["action_02"]["action_table"]["upgrade_actions"]["action_01"] = Reference([[action\upgrade_action\alter_squad_ui_info_action.lua]])
GameData["squad_action_apply_ext"]["actions"]["upgrade_actions"]["action_02"]["action_table"]["upgrade_actions"]["action_01"]["ui_game_item_info"]["hotkey_name"] = [[axis_grenadier]]
GameData["squad_action_apply_ext"]["actions"]["upgrade_actions"]["action_02"]["action_table"]["upgrade_actions"]["action_01"]["ui_game_item_info"]["icon_name"] = [[units\unit_axis_grenadier]]
GameData["squad_action_apply_ext"]["actions"]["upgrade_actions"]["action_02"]["requirement_table"]["required_1"] = Reference([[requirements\required_player_upgrade]])
GameData["squad_action_apply_ext"]["actions"]["upgrade_actions"]["action_02"]["requirement_table"]["required_1"]["ui_name"] = "$0"
GameData["squad_action_apply_ext"]["actions"]["upgrade_actions"]["action_02"]["requirement_table"]["required_1"]["upgrade_name"] = [[upgrade\omg\axis\docmarkers\defensive\tr1\b2\t3.rgd]]
...
GameData["squad_loadout_ext"]["unit_list"]["unit_01"]["type"]["type"] = [[ebps\races\axis\soldiers\walking_wounded.rgd]]
...
GameData["squad_ui_ext"]["hotkey_name"] = [[axis_volksgrenadier]]
